...
public class Customer {
	...
	private Customer(String name, String streetHouseNumber, String postCode, String city, String country,
			String emailAddress) {
		this.name = name;
	...
	public Customer(String name, String streetHouseNumber, String postCode, String city, String country,
			String emailAddress, Shop shop) {
		this(name, streetHouseNumber, postCode, city, country, emailAddress);
		this.customerNumber = shop.getCustomerAmount() + 1;
	}

	public Customer(String name, String streetHouseNumber, String postCode, String city, String country,
			String emailAddress, int customerNumber) {
		this(name, streetHouseNumber, postCode, city, country, emailAddress);
