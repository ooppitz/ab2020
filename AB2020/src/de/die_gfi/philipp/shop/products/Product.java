...
public class Product implements CounterInterface, Discount {
	...
	/**
	 * Construct a Product object with all necessary data for a generic product and
	 * additionally defines a discount
	 *
	 * @param articleNumber      Article number of this product
	 * @param name               Name of this product
	 * @param manufacturer       manufacturer of this product
	 * @param price              Price of this product
	 * @param maxDiscountPercent The maximum discount that can be given in percent
	 *                           (e.g. 15 % would be 15)
	 */
	 ...
	 * <p>
	 * type|article number|name|manufacturer|price
	 * </p>
	 * or
	 * <p>
	 * type|article number|name|manufacturer|price|max discount in percent
	 * </p>
	 *
	 * @param elements A String array, which represents the elements for the
	 *                 constructor
	...
	public static Product parseString(String[] elements) {
		try {
			...
			System.out.println("Couldn't parse product.");
		}
		return null;
	}
	...
	public String toString() {
		return "Product: " + articleNumber + "; " + manufacturer + " " + name + "; price: " + price;
	}
}
