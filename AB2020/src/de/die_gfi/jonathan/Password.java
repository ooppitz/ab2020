...
public class Password {
	...
	public static void main(String[] args) {
		...
		do {
			System.out.println(
					"Bitte geben Sie 'login' oder 'pwd' oder 'mpwd' an, je nachdem welche Aktion sie ausführen möchten:");
	...
	private static void changeMasterPaswd(Scanner sc, int[] pswd) {
		// auch forsellbar mit f�r jeden account individuelle zufallszahlen
		System.out.println("Bitte das Default Password f�r alle accounts festlegen");
